    ...
    return (
        <View style={styles.page}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <TouchableOpacity style={[styles.btn, { backgroundColor: "#f9b700" }]} onPress={handleRegister}>
                    <Text style={styles.btnText}>Register</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.btn, { backgroundColor: "red" }]} onPress={handleLock}>
                    <Text style={styles.btnText}>Lock Device</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.btn, { backgroundColor: "green" }]} onPress={handleUnlock}>
                    <Text style={styles.btnText}>Unlock Device</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.btn, { backgroundColor: "#333" }]} onPress={handleOtp}>
...
const styles = StyleSheet.create({
    ...
    heading: { fontSize: 22, color: "#f9b700", fontWeight: "bold", marginBottom: 10 },
    input: {
        width: "90%",
