...
// Already existing list & register endpoints (you have these)
exports.registerDevice = async (req, res) => { /* ... your current code ... */ };
exports.getAllDevices = async (req, res) => { /* ... your current code ... */ };
